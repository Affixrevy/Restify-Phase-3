...
const PropertyCard = (props) => {
    ...
    return (
        <>
            {color > 0 ? (
                <Link to={url}
                      className="flex flex-col items-start rounded-2xl shadow lg:flex-row lg:h-max-1 text-FONT_COLOR_2 hover:text-gray-700 hover:bg-gray-100 dark:bg-STROKE_COLOR dark:hover:bg-STROKE_COLOR drop-shadow-lg">
                    ...
                    <div className="m-3 ml-4">
                        ...
                        <div className="flex py-2 mb-1">
                            ...
                            <p className="ml-0.5 text-sm font-bold text-current">{property.stars} / 5</p>
                        </div>
                        <h1
