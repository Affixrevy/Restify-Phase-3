                ...
                <div className="mt-6 relative rounded-2xl bg-BACKGROUND_COLOR_2">
                    ...
                    >
                        <div className="flex flex-col space-y-4">
                            ...
                            <button className="bg-BUTTON_COLOR hover:bg-STROKE_COLOR text-FONT_COLOR_1 w-20 font-bold rounded-full">
                        ...
                        <div className="text-FONT_COLOR_2 flex flex-col space-y-4">
                            <div className="flex flex-row mt-4 text-FONT_COLOR_2 h-fit">
                                ...
                                <div className="flex flex-col space-y-2 relative">
                                    ...
                                    <p>*****</p>
                                    <button className="opacity-0 bg-BUTTON_COLOR hover:bg-STROKE_COLOR text-FONT_COLOR_1 w-20 font-bold rounded-full cursor-default">
                                        Edit
                                    </button>
                                </div>
                            </div>
            ...
            content: (
                ...
                >
                    ...
                    <p className="mt-4 text-FONT_COLOR_2">
                        ...
                        <Link className="text-ACCENT_COLOR" to={"/"}> Create your listing today to become an owner!</Link>
                    </p>
                    <button
